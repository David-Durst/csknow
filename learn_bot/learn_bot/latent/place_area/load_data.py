...
class LoadDataResult:
    ...
    def __init__(self, use_manual_data: bool, use_rollout_data: bool, use_synthetic_data: bool, use_all_human_data: bool,
                  add_manual_to_all_human_data: bool, limit_manual_data_to_no_enemies_nav: bool):
