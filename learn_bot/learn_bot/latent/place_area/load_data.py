...
def load_data(use_manual_data: bool, use_rollout_data: bool, use_synthetic_data: bool, use_all_human_data: bool,
    ...
    if use_manual_data:
        dataset_comment = just_bot_comment
        ...
        dataset_comment = just_human_comment + all_comment
        ...
        if add_manual_to_all_human_data:
            dataset_comment = human_with_bot_nav_added_comment
            manual_data = HDF5Wrapper(manual_latent_team_hdf5_data_path, hdf5_id_columns)
            if limit_manual_data_to_no_enemies_nav:
                manual_data.limit((manual_data.id_df[test_success_col] == 1.) & (manual_data.id_df[game_id_column] == 1))
            else:
        ...
        dataset_comment = just_human_comment + limited_comment + "_unfilitered"
    ...
    return LoadDataResult(diff_train_test, dataset_comment,
                          MultiHDF5Wrapper(hdf5_sources, hdf5_id_columns, diff_train_test=diff_train_test,
