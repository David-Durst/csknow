...
def get_place_area_probability(latent_tensor: torch.Tensor, observation: torch.Tensor, col_ranges: List[range]):
    per_player_place_area_probs = latent_tensor * observation
