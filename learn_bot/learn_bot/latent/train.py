...
hyperparameter_option_range = [HyperparameterOptions(num_input_time_steps=5, bc_epochs=60, internal_width=1024, layers=24, learning_rate=1e-6, control_type=ControlType.TimeControl),
