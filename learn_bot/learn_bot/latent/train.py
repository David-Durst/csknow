...
hyperparameter_option_range = [HyperparameterOptions(batch_size=2048, learning_rate=1e-5),
                               HyperparameterOptions(batch_size=2048, learning_rate=1e-6),
                               HyperparameterOptions(batch_size=2048, learning_rate=5e-7),
                               HyperparameterOptions(batch_size=2048, learning_rate=1e-7)]
