...
hyperparameter_option_range = [HyperparameterOptions(num_input_time_steps=1, control_type=ControlType.SimilarityControl),
                               ...
                               HyperparameterOptions(num_input_time_steps=1, control_type=ControlType.SimilarityControl,
                                                     player_mask_type=PlayerMaskType.EveryoneMask, bc_epochs=40),
                               HyperparameterOptions(num_input_time_steps=1, control_type=ControlType.SimilarityControl,
                               ...
                               HyperparameterOptions(num_input_time_steps=1, bc_epochs=160, layers=1, heads=1, control_type=ControlType.SimilarityControl,
                                                     dim_feedforward=256),
                               HyperparameterOptions(num_input_time_steps=1, heads=1, control_type=ControlType.SimilarityControl,
                                                     weight_push=2., weight_save=0.),
                               HyperparameterOptions(num_input_time_steps=1, bc_epochs=80, layers=1, heads=1, control_type=ControlType.SimilarityControl),
                               HyperparameterOptions(num_input_time_steps=1, heads=1, control_type=ControlType.SimilarityControl,
                                                     weight_shoot=50., weight_not_shoot=0.),
                               HyperparameterOptions(num_input_time_steps=1, heads=1, control_type=ControlType.SimilarityControl,
                                                     weight_shoot=50., weight_not_shoot=0., dim_feedforward=256),
                               HyperparameterOptions(num_input_time_steps=1, layers=16, heads=1, control_type=ControlType.SimilarityControl),
                               HyperparameterOptions(num_input_time_steps=1, layers=16, heads=4, control_type=ControlType.SimilarityControl),
                               HyperparameterOptions(num_input_time_steps=1, heads=1, control_type=ControlType.SimilarityControl,
                                                     player_mask_type=PlayerMaskType.EveryoneMask, bc_epochs=40),
                               HyperparameterOptions(num_input_time_steps=1, heads=1, control_type=ControlType.SimilarityControl,
                                                     mask_partial_info=True, player_mask_type=PlayerMaskType.EveryoneMask,
                               ...
                               HyperparameterOptions(num_input_time_steps=3, control_type=ControlType.SimilarityControl,
                                                     drop_history_probability=0.5),
                               HyperparameterOptions(num_input_time_steps=3, control_type=ControlType.SimilarityControl,
                                                     drop_history_probability=0.25),
                               HyperparameterOptions(num_input_time_steps=3, control_type=ControlType.SimilarityControl,
                                                     drop_history_probability=0.75),
                               HyperparameterOptions(num_input_time_steps=3, control_type=ControlType.SimilarityControl,
                                                     drop_history_probability=0.9),
        ...
        with tqdm(total=len(dataloader), disable=False) as pbar:
            for batch, (X, Y, similarity, duplicated_last, indices) in enumerate(dataloader):
                ...
                with autocast(device, enabled=True):
                    ...
                    batch_loss = compute_loss(model, pred_flattened, Y_flattened, X, similarity, X_flattened_orig, X_flattened_rollout,
