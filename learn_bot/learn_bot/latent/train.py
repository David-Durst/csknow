...
hyperparameter_option_range = [HyperparameterOptions(batch_size=2048, learning_rate=4e-5),
                               HyperparameterOptions(batch_size=2048, learning_rate=4e-4),
                               HyperparameterOptions(batch_size=2048, learning_rate=4e-3),
                               HyperparameterOptions(batch_size=2048, learning_rate=4e-2)]
