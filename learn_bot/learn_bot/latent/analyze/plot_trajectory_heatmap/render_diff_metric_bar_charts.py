...
def render_diff_metric_bar_charts(plots_path: Path):
    ...
    for metric_file in metric_files:
        ...
        for col_index, col in enumerate(metrics):
            metric_file_df.plot(x='Data', y=col, kind='bar', rot=0, legend=False, ax=axs[ax_index, col_index])
...
if __name__ == '__main__':
    render_diff_metric_bar_charts(Path("/home/durst/dev/csknow/learn_bot/learn_bot/latent/analyze/similarity_plots/ablation_12_25_23_model_on_12_30_23_harness_learned_no_time_with_partial_1474_rounds"))