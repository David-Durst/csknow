...
def plot_one_metric(title_to_values: Dict[str, List[float]], metric_title: str,
...
def plot_metrics(trajectory_filter_options: TrajectoryFilterOptions, plots_path: Path):
    if trajectory_filter_options.compute_speeds:
        ...
        plot_one_metric(get_title_to_speeds(), 'Weapon/Scoped Scaled Speed', 0.1, 1., 'Percent Max Speed',
    ...
    if trajectory_filter_options.compute_lifetimes:
        ...
        plot_one_metric(get_title_to_lifetimes(), 'Lifetimes', 5, 40., 'Lifetime Length (s)',
