...
rollout_handcrafted_vs_all_human_similarity_hdf5_data_path = Path(__file__).parent / '..' / '..' / '..' / '..' / 'analytics' / 'rollout_outputs' / 'handcrafted_10_19_23_300_rounds_to_human_trajectorySimilarity.hdf5'
rollout_default_vs_all_human_similarity_hdf5_data_path = Path(__file__).parent / '..' / '..' / '..' / '..' / 'analytics' / 'rollout_outputs' / 'default_10_19_23_300_rounds_to_human_trajectorySimilarity.hdf5'
