...
class ColumnTypes:
    ...
    def get_all_columns(self) -> List[str]:
        return self.float_min_max_cols + self.float_non_linear_cols + self.categorical_cols + \
               self.boolean_cols + self.bookkeeping_passthrough_cols
...
class IOColumnTransformers:
    ...
    def __init__(self, input_types: ColumnTypes, output_types: ColumnTypes, all_data_df: pd.DataFrame):
        ...
        self.input_ct = self.create_column_transformer(self.input_types, self.input_ct)
        self.output_ct = self.create_column_transformer(self.output_types, self.output_ct)
    ...
    def get_output_name_range(self, name: str) -> slice:
    ...
    def get_output_name_ranges(self) -> List[str]:
