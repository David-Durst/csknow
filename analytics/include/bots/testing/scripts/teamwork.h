    ...
    virtual void initialize(Tree & tree, ServerState & state) override  {
        if (tree.newBlackboard)  {
            ...
            commands = make_unique<SequenceNode>(blackboard, Node::makeList(
                                                         ...
                                                         make_unique<movement::WaitNode>(blackboard, 0.1),
                                                         make_unique<SlayAllBut>(blackboard, vector{blackboard.neededBots[0].id, blackboard.neededBots[1].id},state),
                                                         make_unique<movement::WaitNode>(blackboard, 0.1),
                                                         ...
                                                         make_unique<movement::WaitNode>(blackboard, 0.1),
                                                         make_unique<Teleport>(blackboard, blackboard.neededBots[1].id, state),
                                                         make_unique<movement::WaitNode>(blackboard, 0.1),
                                                         make_unique<ForceOrderNode>(blackboard, "ForceTCat", vector{blackboard.neededBots[0].id, blackboard.neededBots[1].id}, aToCatPathPlace),
                                                         make_unique<ForceAggressionNode>(blackboard, "ForcePusherBaiter",
                                                                                          vector{blackboard.neededBots[0].id, blackboard.neededBots[1].id},
                                                                                          vector{AggressiveType::Push, AggressiveType::Bait}),
                                                         make_unique<ParallelFirstNode>(blackboard, Node::makeList(
                                                                                                make_unique<PusherReachesCatBeforeBaiter>(blackboard, blackboard.neededBots[0].id, blackboard.neededBots[1].id),
