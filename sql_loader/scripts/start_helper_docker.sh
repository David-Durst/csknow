...
psql --user=postgres -d csknow -c "\\copy equipment FROM '${dir_path}/dimension_table_equipment.csv' csv header;"
psql --user=postgres -d csknow -c "\\copy game_types FROM '${dir_path}/dimension_table_game_types.csv' csv header;"
psql --user=postgres -d csknow -c "\\copy hit_groups FROM '${dir_path}/dimension_table_hit_groups.csv' csv header;"
psql --user=postgres -d csknow -c "\\copy games FROM '${dir_path}/global_games.csv' csv header;"
