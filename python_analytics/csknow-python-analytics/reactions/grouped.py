...
makeHistograms('avg_hand_react', 'avg_cpu_react', makePlotterFunction(0.2, False), True, True, 'count_avg', 'Reaction Time (s)')
makeHistograms('avg_hand_react', 'avg_cpu_react', makePlotterFunction(0.2, True), True, False, 'pct_avg', 'Reaction Time (s)')
...
makeLogReg(hand_filtered_df, 'avg_hand_react', 'Hand')
makeLogReg(cpu_filtered_df, 'avg_cpu_react', 'CPU')
